...
namespace ServiceApp.Data.Migrations
{
    ...
    [Migration("20190226202540_AddNumenclaturesOneToOne")]
    partial class AddNumenclaturesOneToOne
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ServiceApp.Data.Models.Delivery", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("ServiceApp.Data.Models.DeliveryRaw", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("ServiceApp.Data.Models.DeliveryRaw", b =>
                {
                    b.HasOne("ServiceApp.Data.Models.Delivery", "Delivery")
                        .WithMany("Raws")
            ...
            modelBuilder.Entity("ServiceApp.Data.Models.Part", b =>
                {
                    ...
                    b.HasOne("ServiceApp.Data.Models.Supplier")
                        .WithMany("Parts")
                        .HasForeignKey("SupplierId");
