        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Obligation = table.Column<decimal>(nullable: false),
                    ServiceAppUserId = table.Column<string>(nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Obligations_AspNetUsers_ServiceId",
                        column: x => x.ServiceId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Obligations_Suppliers_SupplierId",
                        column: x => x.SupplierId,
                        principalTable: "Suppliers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Offers_AspNetUsers_ServiceId",
                        column: x => x.ServiceId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Orders_AspNetUsers_ServiceId",
                        column: x => x.ServiceId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PriceOfWork = table.Column<decimal>(nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_OfferRaws", x => x.Id);
                    table.ForeignKey(
                        name: "FK_OfferRaws_Offers_OfferId",
                        column: x => x.OfferId,
                        principalTable: "Offers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_OfferRaws_Parts_PartId",
                        column: x => x.PartId,
                        principalTable: "Parts",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_OffersParts", x => x.Id);
                    table.ForeignKey(
                        name: "FK_OffersParts_Offers_OfferId",
                        column: x => x.OfferId,
                        principalTable: "Offers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_OffersParts_Parts_PartId",
                        column: x => x.PartId,
                        principalTable: "Parts",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_OrderRaws", x => x.Id);
                    table.ForeignKey(
                        name: "FK_OrderRaws_Orders_OrderId",
                        column: x => x.OrderId,
                        principalTable: "Orders",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_OrderRaws_Parts_PartId",
                        column: x => x.PartId,
                        principalTable: "Parts",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Obligations_ServiceId",
                table: "Obligations",
                column: "ServiceId");

            migrationBuilder.CreateIndex(
                name: "IX_Obligations_SupplierId",
                table: "Obligations",
                column: "SupplierId");

            migrationBuilder.CreateIndex(
                name: "IX_OfferRaws_OfferId",
                table: "OfferRaws",
                column: "OfferId");

            migrationBuilder.CreateIndex(
                name: "IX_OfferRaws_PartId",
                table: "OfferRaws",
                column: "PartId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OffersParts_OfferId",
                table: "OffersParts",
                column: "OfferId");

            migrationBuilder.CreateIndex(
                name: "IX_OffersParts_PartId",
                table: "OffersParts",
                column: "PartId");

            migrationBuilder.CreateIndex(
                name: "IX_OrderRaws_OrderId",
                table: "OrderRaws",
                column: "OrderId");

            migrationBuilder.CreateIndex(
                name: "IX_OrderRaws_PartId",
                table: "OrderRaws",
                column: "PartId");
